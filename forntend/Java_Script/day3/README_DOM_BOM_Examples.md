# 📘 JavaScript DOM & BOM Examples – أمثلة على DOM و BOM
...
**نموذج كائنات المستند**

يُستخدم للتعامل مع عناصر صفحة **HTML** وتعديلها باستخدام JavaScript، مثل النصوص، الصور، الأزرار، والعناصر المختلفة.

## 🔹 BOM – Browser Object Model

**نموذج كائنات المتصفح**

يُستخدم للتعامل مع **المتصفح نفسه** باستخدام JavaScript، مثل نافذة المتصفح، الرابط الحالي، سجل التصفح، والتنبيهات.
